...
/*   Updated: 2020/09/07 18:29:57 by choeunsig        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	c_i_p_p_inner(int *len_count,
		int zero_cnt, char *string_int, t_flag *flag_info)
{
...
int		case_int_precision_print(char *string_int, t_flag flag_info)
{
	int		zero_cnt;
	int		len_count;
...
void	case_int_left_right(char *str_int, t_flag flag_info)
{
	int		is_minus;
	char	c;
...
t_flag	treat_int_flag(char *str_int, t_flag flag_info)
{
