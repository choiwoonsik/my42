...
/*   Updated: 2020/09/07 18:29:58 by choeunsig        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../ft_printf.h"

int		case_hexa_precision_print(char *string_int, t_flag flag_info)
{
	int		zero_cnt;
	int		len_count;
...
void	case_hexa_left_right(char *str_int, t_flag flag_info)
{
	char	c;
...
t_flag	treat_hexa_flag(char *str_int, t_flag flag_info)
{
...
char	*case_hexa_make_str(unsigned int hexa, int is_big, t_flag *flag_info)
{
	char	*string_hexa;
	int		n;
...
int		case_hexa_print(unsigned int hexa, int is_big, t_flag flag_info)
{
	char	*string_hexa;
	int		len_count;
