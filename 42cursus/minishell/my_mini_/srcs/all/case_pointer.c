...
/*   Updated: 2020/09/07 18:29:56 by choeunsig        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../ft_printf.h"

int		case_pointer_precision_print(char *string_int, t_flag flag_info)
{
	int		len_count;
...
void	case_pointer_left_right(char *str_int, t_flag flag_info)
{
	char	c;
...
t_flag	treat_pointer_flag(char *str_int, t_flag flag_info)
{
...
int		case_pointer_print(unsigned long long pointer, t_flag flag_info)
{
	char	*string_pointer;
	int		len_count;
